...
<table class="gridtable" border="1" bgcolor="#ffffff" align="center" cellspacing="1" cellpadding="1">
    <form action="own_action!chan?car_run.id=<%=request.getParameter("id")%>&shan=<%=request.getParameter("pic")%>&inventory=<%=request.getParameter("inventory")%>"  method="post" enctype="multipart/form-data">
        <tr align="center">
            <td>名称：</td>
